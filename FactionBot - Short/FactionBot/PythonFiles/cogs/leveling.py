...
All persistence goes through :mod:`cogs.botkit`. This module never imports
from Bot.py.
"""
...
try:  # loaded as a package extension (cogs.leveling) — preferred
...
class LevelingCog(commands.Cog, name="Leveling"):
    ...
    # ------------------------------------------------------------------
    @commands.hybrid_command(name="rank", aliases=["lvl", "xprank"])
    @commands.guild_only()
    ...
    # ------------------------------------------------------------------
    @commands.hybrid_group(name="level", invoke_without_command=True)
    @commands.guild_only()
