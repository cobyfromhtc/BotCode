...
helpers) comes from :mod:`cogs.botkit` — this module never imports Bot.py.
"""
...
class AutoModCog(commands.Cog, name="AutoMod"):
    ...
    # automod add
    # ------------------------------------------------------------------
    @automod.command(name="add", with_app_command=True)
    ...
    # automod list
    # ------------------------------------------------------------------
    @automod.command(name="list", with_app_command=True)
    ...
    @automod.command(name="remove", with_app_command=True)
    @commands.has_permissions(manage_guild=True)
    ...
    @automod.command(name="enable", with_app_command=True)
    @commands.has_permissions(manage_guild=True)
    ...
    @automod.command(name="disable", with_app_command=True)
    @commands.has_permissions(manage_guild=True)
    ...
    @automod.command(name="exempt", with_app_command=True)
    @commands.has_permissions(manage_guild=True)
    async def exempt(
        self,
        ctx: commands.Context,
    ...
    @automod.command(name="unexempt", with_app_command=True)
    @commands.has_permissions(manage_guild=True)
    async def unexempt(
        self,
        ctx: commands.Context,
    ...
    # automod config
    # ------------------------------------------------------------------
    @automod.command(name="config", with_app_command=True)
    @commands.has_permissions(manage_guild=True)
    async def config(
    ...
    @strikes.command(name="clear", with_app_command=True)
    @commands.has_permissions(manage_guild=True)
    ...
    # ------------------------------------------------------------------
    @automod.command(name="test", with_app_command=True)
    @commands.has_permissions(manage_guild=True)
    ...
    # automod logs
    # ------------------------------------------------------------------
    @automod.command(name="logs", with_app_command=True)
    ...
    # ------------------------------------------------------------------
    @automod.command(name="ruleset", with_app_command=True)
